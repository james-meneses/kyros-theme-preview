...
import { footerLinks } from "@/data/brand";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12 md:py-16">
          ...
          <div className="flex-1 max-w-sm">
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5" style={{ color: "var(--foreground-muted)" }} />
                <Input
                  type="email"
              ...
              <button
                className="px-4 h-9 text-xs font-semibold inline-flex items-center gap-1 cursor-pointer"
                style={{
        ...
        <div className="mt-8 pt-6 border-t" style={{ borderColor: "var(--border)" }}>
          <p className="text-xs" style={{ color: "var(--muted-foreground)" }}>
            &copy; {new Date().getFullYear()} Kyros. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
